      ...
      <div className="relative rounded-lg bg-black py-24
       text-blue-50 sm:overflow-hidden">
         ...
         overflow-hidden sm:block lg:left-20 lg:w-96">
           ...
           sm:top-1/2 md:left-auto md:right-10 lg:top-20
           lg:w-80">
       ...
       <div className="flex flex-col items-center text-center">
            ...
            <p className="special-font mt-10 w-full font-family-zentry
            text-5xl leading-[0.9] md:text-[6rem] z-10 mix-blend-exclusion">
                Lets b<b>u</b>ild a<br/> new err<b>a</b> of<br/>  G<b>a</b>mi<b>n</b>g T<b>o</b>gether
            </p>
