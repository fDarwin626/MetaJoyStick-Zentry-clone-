...
// Register Scrolltrigger or any gsap plugins below//
...
const Hero = () => {
  ...
  return (
    <div id='lobby' className="relative h-dvh w-screen
     overflow-x-hidden">
      {isLoading && (
      ...
      bg-blue-75">
        <div className="">
            ...
            overflow-hidden">
              ...
              hover:opacity-100">
                <video src={getVideoSrc(upcomingVideosIndex)}
                  ref={currentVideoRef}
                  loop 
                  muted
                  id="current-video"
        ...
        <div className="absolute left-0 top-0 size-full z-40">
         <div className="mt-24 px-5 sm:px-10">
           ...
           text-blue-100">
            ...
            leftIcon={<TiLocationArrow/>} containerClass='
